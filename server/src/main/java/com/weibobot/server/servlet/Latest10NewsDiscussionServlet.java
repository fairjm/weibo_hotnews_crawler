 ...
 */
@WebServlet("/news/latest/discussnum")
public class Latest10NewsDiscussionServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    private final String name = "lastest_discuss_num";

    private final String title = "最新的新闻讨论量";
    ...
    private synchronized void refreshFile(final File file) throws IOException {
        ...
        for (final News n : newsList) {
            m.put(n.getTitle(), n.getDiscussNum() + "");
        }
